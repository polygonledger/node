...
var name string = "www.polygonnode.com"
var target string = "polygonnode.com"
var TTL int64
var weight = int64(1)
var zoneId string = "us-east-1"
...
func main() {
	...
	//go run route.go -d www.your-domain.com -t your-domain.com -z [Your Zone Id]
